    ...
    <div className="flex min-h-screen bg-[#FAFBFF] relative overflow-hidden">
      ...
      <aside className="w-[306px] min-h-screen bg-white shadow-[0px_10px_60px_rgba(226,236,249,0.5)] flex flex-col justify-between py-9 px-7 border-r border-[#F0F4FA] shrink-0 z-10">
        ...
        <div className="flex flex-col gap-6">
          {/* Upgrade to Pro Gradient card (Rectangle 33 / Access Pro in Figma) */}
          <div className="p-5 bg-gradient-to-tr from-[#EAABF0] to-[#4623E9] rounded-2xl relative shadow-lg shadow-[rgba(70,35,233,0.15)] flex flex-col items-center">
            <p className="text-center font-semibold text-sm text-white leading-5 mb-4">
              Upgrade to PRO to get access all Features!
            </p>
            <button className="w-full bg-white py-2.5 rounded-full text-center text-[#4925E9] font-poppins font-bold text-xs shadow-md transition-all hover:scale-105 active:scale-95 cursor-pointer">
              Get Pro Now!
            </button>
          </div>
